...
export default {
        ...
        <main v-else class="page-list">
            ...
            <div class="level-container">
                <div class="level" v-if="level">
                    ...
                    <ul class="stats">
                        <li>
                            <div class="type-title-sm">Pontos ganhos ao completar</div>
                        ...
                        <li>
                            ...
                            <p>{{ level.password || 'Cópia aberta' }}</p>
                        </li>
                    </ul>
                    <h2>Recordes</h2>
                    ...
                    <p v-else>Este level não aceita recordes novos</p>
                    <table class="records">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <div class="og">
                        <p class="type-label-md">Website layout: <a href="https://tsl.pages.dev/" target="_blank">TSL</a></p>
                    </div>
    ...
    async mounted() {
        ...
        if (!this.list) {
            this.errors = [
                "Falha ao carregar a lista. Tente novamente em alguns minutos.",
            ];
        } else {
            this.errors.push(
                ...this.list
